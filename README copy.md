...
Everything below this line of the readme is intended to be included in the actual repository, with 'python-template-repo' replaced with the actual name of the repository. In addition, 'python-template-repo' should be changed to the new name in "pyproject.toml" and the name of the "python_template_repo" folder.

## API Documentation

Automatically-generated documentation is available at <https://github.gatech.edu/pages/kchoislattery3/python-template-repo>.
...
- Run all tests (from the tests folder and from the docstrings): `pytest tests/ && xdoctest python_template_repo`
